...
public abstract class PropertyGroup {
     ...
     * @see #load(String, ResourceLocation, InputStream)
     * @see #getExtension()
     * @see PropertiesGroupAdapter
     ...
     * @throws ResourceLocationException if encountered a malformed {@link ResourceLocation} while reading
     */
    public abstract PropertyGroup load(String packName, ResourceLocation identifier, InputStream is) throws IOException, ResourceLocationException;
